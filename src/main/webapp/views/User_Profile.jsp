    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="header">
                ...
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h3 class="display-4">Your Profile</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="container my-12 mx-auto px-4 md:px-12">
                <form class="row g-3" method="post" action="<%=request.getContextPath()%>/EditProfileServlet">
                    <div class="col-md-2">
                        <div class="form-outline">
                            <input value="${user.userName}" name="userName" type="text" class="form-control" id="validationDefault01" contenteditable="false" required />
                            <label for="validationDefault01" class="form-label font-italic">Your ID
                    ...
                    <div class="col-md-4">
                        <div class="form-outline">
                            <input value="${user.password}" name="password" type="text" class="form-control" id="validationDefault02"
                                required />
                            <label for="validationDefault02" class="form-label font-italic">Your Password</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-outline">
                            <input value="${user.email}" name="email" type="email" class="form-control" id="validationDefault03" required />
                            <label for="validationDefault03" class="form-label font-italic">Your Email</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-outline">
                            <input value="${user.fullName}" name="fullName" type="text" class="form-control" id="validationDefault04" required />
                            <label for="validationDefault04" class="form-label font-italic">Your Name</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <!-- Default radio -->
                        ...
                        <div class="form-check">
                            <input <c:if test="${user.admin == true}"> checked</c:if> name="admin" value="true" class="form-check-input" type="radio" disabled
                        ...
                        <div class="form-check">
                            <input <c:if test="${user.admin == false}"> checked</c:if> name="admin" value="false" class="form-check-input" type="radio" disabled
