            ...
            <div class="row" id="row-header">
                <div class="col-12">
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <a class="navbar-brand" href="<%=request.getContextPath()%>/Homepage"><img src="https://ap.poly.edu.vn/images/logo.png" alt=""></a>
            ...
            <div class="login-wrap">
                <div class="login-html">
                    <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1"
                        class="tab">Share Video</label>
                    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
                    <div class="login-form">
                        <form action="<%=request.getContextPath()%>/ShareVideo?videoId=${videoId}" method="POST">
                        <div class="sign-in-htm">
                            <div class="group">
                                <label for="password" class="label">Friend's Email</label>
